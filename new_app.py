...
encoded_geo = onehot_encoding.transform([[geography]]).toarray()
encoded_geo_df = pd.DataFrame(encoded_geo, columns=onehot_encoding.get_feature_names_out(['Geography']))
